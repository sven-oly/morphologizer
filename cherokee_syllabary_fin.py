...
final = FST.re("$Lexicon @ $rule1 @ $rule2 @ $rule2_1 @ $rule3 @ $metathesis1 @ $metathesis2 @ $aspiration1 @ $aspiration2 @ $trn @ $ngt1 @ $ngt2 @ $ngt3 @ $ngt4 @ $ngt5 @ $rule4 @ $rule5 @ $rule6 @ $cleanup1 @ $rule8 @ $rule9 @ $cleanup2 @ $kw @ $k @ $y @ $j @ $w @ $n @ $t @ $h @ $Ꮝ @ $l @ $drops", fsts)
